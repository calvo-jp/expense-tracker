...
export const DatePicker = withProvider(styled(parts.Root), 'root');
...
export const DatePickerPositioner = withContext(styled(parts.Positioner), 'positioner');
export const DatePickerPrevTrigger = withContext(
	styled(parts.PrevTrigger),
	'prevTrigger',
);
export const DatePickerRangeText = withContext(styled(parts.RangeText), 'rangeText');
export const DatePickerTable = withContext(styled(parts.Table), 'table');
export const DatePickerTableBody = withContext(styled(parts.TableBody), 'tableBody');
export const DatePickerTableCell = withContext(styled(parts.TableCell), 'tableCell');
export const DatePickerTableCellTrigger = withContext(
	styled(parts.TableCellTrigger),
	'tableCellTrigger',
);
export const DatePickerTableHead = withContext(styled(parts.TableHead), 'tableHead');
export const DatePickerTableHeader = withContext(
	styled(parts.TableHeader),
	'tableHeader',
);
export const DatePickerTableRow = withContext(styled(parts.TableRow), 'tableRow');
...
export const DatePickerYearSelect = withContext(styled(parts.YearSelect), 'yearSelect');
