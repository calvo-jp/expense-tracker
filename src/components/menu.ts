...
export const Menu = withProvider(styled(parts.Root));
...
export const MenuOptionItem = withContext(styled(parts.OptionItem), 'optionItem');
export const MenuPositioner = withContext(styled(parts.Positioner), 'positioner');
...
export const MenuTriggerItem = withContext(styled(parts.TriggerItem), 'triggerItem');
