...
export const AccordionItemContent = withContext(styled(parts.ItemContent), 'itemContent');
export const AccordionItemIndicator = withContext(
	styled(parts.ItemIndicator),
	'itemIndicator',
);
export const AccordionItemTrigger = withContext(styled(parts.ItemTrigger), 'itemTrigger');
